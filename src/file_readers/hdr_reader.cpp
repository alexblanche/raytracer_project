...
//         const bool x_orientation  = l1_is_x ? s1 == '+' : s2 == '+';
//         const bool y_orientation  = l1_is_x ? s2 == '+' : s1 == '+';
...
exit_status read_hdr(const char* file_name, std::vector<std::vector<rt::color>>& data) {
